...
import ee.sample.apps.context.user.application.service.DeleteUser;
import ee.sample.apps.context.user.application.service.PersistUser;
import ee.sample.apps.context.user.application.service.SearchUser;
import ee.sample.apps.context.user.application.service.UpdateUser;
